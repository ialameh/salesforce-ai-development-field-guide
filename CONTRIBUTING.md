# Contributing to the Salesforce AI Development Field Guide
...
- Every chapter ends with a `## What to Check` quick-reference section.
...
- All claims must cite a canonical source.